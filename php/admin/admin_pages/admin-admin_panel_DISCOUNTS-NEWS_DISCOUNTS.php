...
<div class="w-100_percent_h-clac_100vh-80px div-positon_relative padding-45px">
    <div class="dicounts_news-body-content div_display-flex">
        <div id="dicounts-container" class="div_display-flex_justify-content-center_align-items-center div_flex-wrap_wrap">
            <?php
            include('../../admin/admin_backend/discounts_take_img_for_admin.php');
            ?>
            <div id="discounts-change_img" class="dicounts_news-body-cell">
...
<script src="../../../js1/admin/admin-discounts_save_url-change_img.js"></script>
<script src="../../../js1/admin/admin-discounts_delete_url-change_img.js"></script>