...
$sql = "SELECT `akcijas_foto` FROM `akcija`";
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<div class='dicounts_news-body-cell'>";
        ...
        echo "<img class='dicounts_news-img' src='$url' alt=''>";
            ...
            echo "<div class='discounts-delete-btn div-position_absolute-top_0-right_0 padding-top-18px padding-right-18px cursor_pointer'>";
