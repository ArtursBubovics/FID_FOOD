...
<body class="div-positon_relative">
                    ...
                    <div class="padding-top-20px">
                        <div class="div_display-flex_justify-content-flex-end_align-items-center padding-right-12px">
                            ...
                            <div class="div_display-flex">
                                <div>
                                    <p id="total_price" class="p-font_size_18px text_color-green"></p>
                                </div>
                                <div>
                                    <p class="p-font_size_18px text_color-green">€</p>
                                </div>
                            </div>
                        </div>
    ...
    <div id="basketPopup" class="popup  w-100_percent_h-10_percent div-position_absolute div_display-flex_justify-content-center_align-items-center ">
    ...
    <div id="basketLoginPopup" class="popup  w-100_percent_h-10_percent div-position_absolute div_display-flex_justify-content-center_align-items-center ">
    <div class="w_and_h-auto padding-20px background_color-white div-border_radius-border_none-box_shadow_0px_0px_0px_1px_rgba-0_0_0_06 z-index_10 div_display-flex_justify-content-center_align-items-center">
        <div class="div_display-flex_justify-content-center_align-items-center padding-right-6px">
            <img src="../../../img1/icon-info.png" alt="">
        </div>
    ...
    <script src="../../../js1/izvelne/izvelen-count_of_sum.js"></script>
    <script src="../../../js1/izvelne/izvelne-delete_order.js"></script>
</body>