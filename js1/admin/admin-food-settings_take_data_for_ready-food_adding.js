$(document).ready(function() {
    ...
    $('#btnSettingsShowField').click(function() {
      // Получаем выбранное значение из <select>
      var selectedValue = $(this).closest('.card').find('#settingsSelect').val();

      var existingElement = $('.settings p:contains(' + selectedValue + ')');
      ...
      var newDiv = $('<div>', {
        class: 'settings_field w_and_h-auto div_display-flex padding-left-18px padding-top-6px',
        html: `
          <div>
              <p class="p-font_size_23px">${selectedValue}</p>
          </div>
          <div class="settings_delete-btn div_display-flex">
      ...
      $('#settingsDivContainer').append(newDiv);
    });
  });