$(document).ready(function() {
    ...
    $('#btnAllergyShowField').click(function() {
      // Получаем выбранное значение из <select>
      var selectedValue = $(this).closest('.card').find('#allergySelect').val();

      var existingElement = $('.allergy_field p:contains(' + selectedValue + ')');
      ...
      var newDiv = $('<div>', {
        class: 'allergy_field w_and_h-auto div_display-flex padding-left-18px padding-top-6px',
        html: `
          <div>
              <p class="p-font_size_23px">${selectedValue}</p>
          </div>
          <div class="allergy_delete-btn div_display-flex">
      ...
      $('#allergyDivContainer').append(newDiv);
    });
  });