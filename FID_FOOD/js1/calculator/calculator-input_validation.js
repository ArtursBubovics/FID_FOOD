$(document).ready(function () {
    ...
    $(".count").click(function () {
        if((calculator_chech_gender() == noMistakes)){
            if((calculatr_chech_ageWeightHeight() == noMistakes)){
                if((calculator_chech_btns() == noMistakes)){
                    ageVerificheckErroscation(users_goal);
                }   
            }
        }
    })
